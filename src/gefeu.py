...
def _main(
        ...
        t_Epochs: int = 7,
        t_Learning_Rate: float = 0.24,
        t_Batch_Size: int = 100, 
        t_N2R_Ratio: int = 4.75, 
        t_Regularization_term: float = 0.07,
        t_Layers: list = [1024,1024,1024,1024,1024,],
        t_Noise_Dim: int = 128,
        t_Impair_LR: float = 0.04,
